...
**Python Data Analytics** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_JasonSastra/tree/master/python_data_analytics)]: An ELT pipeline alongside a database analysis for a dataset given by LGS done by utilizing an SQL docker to store the data and a Jupyter Notebook to work on the data. Utilizes Python Pandas Library to process the data and display them to present relevant information to stakeholders. Analyzed various trends alongside RFM segmentation in order to present insights that can improve sales"

**Databricks Fundamental** [[GitHub](https://github.com/jarviscanada/jarvis_data_eng_JasonSastra/tree/master/spark)]: Developed an ELT pipeline to analysize Financial data related to frauds. Utilized Azure SQL Database alongside with Azure Delta Data Lake to store relevant datasets. Then utilized Databricks in order to host a spark analysis on the datasets, utilizing the three medallion structure to parse the data then using databricks dashboards to showcase the data. Analysis includes potential methods to prevent fraud alongside analysis on common similarities between fraud cases.
